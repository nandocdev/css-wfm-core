...
class CsvTableSeeder extends Seeder {
    ...
    private const ROLE_PERMISSION_PATTERNS = [
        ...
        'Supervisor' => [
            ...
            'analytics.monitoring.readonly.view',
        ],
        'Coordinador' => [
            'auth.',
            'security.profile.',
            ...
            'analytics.reporting.coordinator.view',
            'analytics.monitoring.readonly.view',
        ],
        'Jefe' => [
            'auth.',
            ...
            'workflow.exceptions.force_approve',
            'analytics.dashboard.executive.view',
            'analytics.reporting.management.view',
