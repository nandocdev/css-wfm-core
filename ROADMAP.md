...
Este roadmap ha sido validado contra el documento de [Casos de Uso (v1.0)](docs/00-overview/03_casos_uso.md) para garantizar cobertura total.
...
- [ ] **Configuración Base y Core**
    ...
    - [ ] Catálogos base: `provinces`, `districts`, `townships`, `employment_statuses`, `incident_types`.
...
- [ ] **Módulo: Security & Administration**
    - [ ] Migración de `users` y roles/permisos (Spatie).
