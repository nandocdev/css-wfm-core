...
final readonly class UpdateBreakTemplateAction {
     ...
     */
    public function execute(BreakTemplate $breakTemplate, array $payload): BreakTemplate {
        ...
        /** @var BreakTemplate $updated */
        $updated = $this->databaseManager->transaction(function () use ($breakTemplate, $payload): BreakTemplate {
            $breakTemplate->forceFill([
                'name' => $payload['name'],
